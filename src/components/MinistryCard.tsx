...
function MinistryCardImpl({ ministry, showActions = false, onEdit, onDelete }: MinistryCardProps) {
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-4 mt-3 text-sm text-gray-500">
            <div className="flex items-center gap-1">
              ...
              <span>{ministry.member_count || 0} {ministry.member_count === 1 ? 'member' : 'members'}</span>
            </div>
          </div>
        </div>
...
export const MinistryCard = memo(MinistryCardImpl)
...
function CompactMinistryCardImpl({ ministry, onClick }: CompactMinistryCardProps) {
  const deptColor = departmentColors[ministry.department || ''] || 'bg-gray-100 text-gray-800'
...
export const CompactMinistryCard = memo(CompactMinistryCardImpl)
